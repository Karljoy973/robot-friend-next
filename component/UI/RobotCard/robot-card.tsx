...
const RobotCard = ({ name, email, robotId }: RobotCardArgs) => {
    let Id = uuidv7()
    return (<>
        <div id={robotId?? Id} className="flex w-3xs flex-col justify-center items-center rounded-2xl bg-teal-200">
            ...
            <span className="grow flex flex-col justify-center items-center my-4">
                <h2 className="w-fit text-xl font-semibold font-[system-ui] text-black">{name}</h2>
